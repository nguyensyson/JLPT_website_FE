    ...
    >
      ...
      <div
        className={cn(
          ...
          variant === "floating" && "p-2 group-data-[side=left]:left-2 group-data-[side=right]:right-2",
          variant === "inset" && "p-2 group-data-[side=left]:left-2 group-data-[side=right]:right-2",
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] after:-translate-x-1/2 after:bg-sidebar-border after:transition-all after:duration-200 hover:after:bg-sidebar-accent-foreground group-data-[side=left]:-right-4 group-data-[side=right]:-left-4 sm:flex",
